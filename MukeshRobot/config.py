...
class Config(object):
    ...
    TOKEN = "7884884953:AAEJ0T10YaJyaPsBhj7s_27XacqH7i_XMbo"  # This var used tbe API_KEY but it is now TOKEN, adjust accordingly.
    ...
    # RECOMMENDED
    DATABASE_URL = "postgres://ytfzobkz:rpmSJLahnPE7tfi2dwnmz335zYYov6tS@kandula.db.elephantsql.com/ytfzobkz"  # A sql database url from elephantsql.com
